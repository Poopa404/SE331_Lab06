...
<template>
  <header class="max-h-screen leading-normal">
    ...
    <nav>
      <nav class="flex">
        <ul v-if="!authStore.currentUserName" class="flex ml-auto navbar-nav">
          <li to="nav-item px-2">
      ...
      <router-link :to="{ name: 'organizer-list' }">Organizer List</router-link> |
      <span v-if="authStore.isAdmin">
        <router-link :to="{ name: 'add-organizer' }">New Organizer</router-link>
      </span>
    </nav>
  </header>
